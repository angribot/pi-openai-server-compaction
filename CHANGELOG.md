...
## Unreleased
- build remote compaction input from Pi's effective context and Responses converters, preserving prior summaries, contextual messages, shell output, assistant item metadata, and tool compatibility behavior
